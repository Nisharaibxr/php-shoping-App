...
#header {
  background: #5F4B8B;  /* fallback for old browsers */
  background: -webkit-linear-gradient(to right, #88A2AA, #5F4B8B);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #88A2AA, #5F4B8B); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
#footer, #bottom-footer {
  ...
  background: -webkit-linear-gradient(to right, #FF6A88, #FF9A8B);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #FF6A88, #FF9A8B); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
